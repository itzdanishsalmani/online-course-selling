...
//                 <div className="ml-1 text-white text-xl font-bold">100xdevs</div>
//             </div>
...
//                     <div className="text-white font-bold text-lg md:text-4xl">What is 100xdevs?</div>
//                     <div className="mt-4 text-custom-light text-xs md:mr-12 md:text-lg">100xDevs, a learning platform that offers courses on the latest trends
//                         in the software engineering industry. Whether you're a beginner or
//                         looking to upgrade your skills, 100xDevs provides a user-friendly
...
//             <div className="text-custom-blue text-center font-bold text-2xl md:text-4xl">Why 100xdevs?</div>
...
//                 <div className="ml-4 mr-4 mt-4 text-slate-600 md:ml-72 md:mr-40 md:text-lg md:font-medium ">No compromises. With 100xdevs, you don't have to choose between different tutors and random tutorials. Get the power of building production-ready applications.</div>
//             </div>
...
//                     <div className="md:mt-3 text-slate-600 text-sm   md:mr-12 md:text-lg">Harkirat is best in India, when it comes to learning about remote work, open source and landing a job.</div>
//                 </div>
...
//                     <div className="mt-3 text-slate-600 text-sm md:mr-12 md:text-lg">Harkirat personally creates assignments after every lecture, so it's extremely hands on.</div>
//                 </div>
//             </div>
//         </div>
//     )
...
//             <div className="text-white text-center font-bold text-2xl md:text-4xl">About 100xdevs</div>
//             <div className="font-medium text-lg md:pl-52 pt-4 md:text-2xl">
//                 <div className="text-custom-light ml-4">Welcome to<span className="text-custom-light-blue">100xdevs,</span></div>
//             </div>

//             <div className="text-custom-light mt-3 md:pl-52 md:pr-52 md:text-xl">
//                 <div className="ml-4 mr-4 text-lg text-medium">
//                     <div>This is an initiative by <span className="text-custom-light-blue">Harkirat Singh</span> to personally mentor folks in the field of Programming.</div>
//                      <div>Harkirat strongly feels that today you are either a 1x engineer or a 100x engineer and nothing in the middle,
...
//             <div className="text-center text-custom-light mt-3 md:pl-52 md:pr-52 md:text-xl">Give yourself the power you deserve with a 100xdevs today!</div>
//             <div className="">
